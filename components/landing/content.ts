...
export const faqItems: FaqItem[] = [
  {
    question: "Langkrua เป็นระบบรับออเดอร์จากลูกค้าหรือไม่?",
    answer:
      "ไม่ใช่ Langkrua เป็นระบบจัดการหลังร้าน สำหรับดูแลวัตถุดิบ สูตรอาหาร ต้นทุน ราคาขาย และบันทึกยอดขายภายในร้าน",
  },
  {
